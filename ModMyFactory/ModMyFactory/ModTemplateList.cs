...
namespace ModMyFactory
{
    ...
    sealed class ModTemplateList
    {
        ...
        {
            if (factorioVersion.GetFactorioShortVersion() >= FactorioVersion.DisableBehaviourSwitch)
            {
        ...
        public bool GetActive(string name, GameCompatibleVersion version, GameCompatibleVersion factorioVersion, bool isOnly)
        {
            ...
            {
                if ((factorioVersion.GetFactorioShortVersion() >= FactorioVersion.DisableBehaviourSwitch) && !isOnly)
                {
