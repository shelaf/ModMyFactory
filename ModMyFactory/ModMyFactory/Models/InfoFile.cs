...
namespace ModMyFactory.Models
{
    ...
    sealed class InfoFile
    {
        ...
        /// <summary>
        /// The accurate version of Factorio this mod is compatible with.
        /// </summary>
        [JsonProperty("factorio_version")]
        [JsonConverter(typeof(GameVersionConverter))]
        public GameCompatibleVersion AccurateFactorioVersion { get; }
        ...
        /// To be valid, the <see cref="Name"/>, <see cref="Version"/> and <see cref="AccurateFactorioVersion"/> properties must be non-null.
        /// </summary>
        public bool IsValid => !string.IsNullOrWhiteSpace(Name) && (Version != null) && ((Name == "base") || (AccurateFactorioVersion != null));

        [JsonConstructor]
        private InfoFile(string name, GameCompatibleVersion version, GameCompatibleVersion accurateFactorioVersion, string friendlyName, string author, string description, ModDependency[] dependencies)
        {
            Name = name;
            Version = version;
            AccurateFactorioVersion = accurateFactorioVersion;
            FactorioVersion = null;
            if (accurateFactorioVersion != null)
            {
                FactorioVersion = accurateFactorioVersion.GetFactorioShortVersion();
            }
