...
namespace ModMyFactory.Web
{
    ...
    static class ModWebsite
    {
        ...
        {
            DirectoryInfo modDirectory = App.Instance.Settings.GetModDirectory(release.InfoFile.FactorioVersion.GetFactorioShortVersion());
            ...
            try
            {
                ...
                if (!cancellationToken.IsCancellationRequested)
                {
                    ...
                    {
                        if (modFile.InfoFile.AccurateFactorioVersion == release.InfoFile.FactorioVersion)
                        {
